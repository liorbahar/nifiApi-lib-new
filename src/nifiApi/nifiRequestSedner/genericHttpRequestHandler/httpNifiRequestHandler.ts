...
import { IHttpNifiRequestHandler } from "./IhttpNifiRequestHandler";

export class HttpNifiRequestHandler implements IHttpNifiRequestHandler {
    private requestSender: INifiApiConnection;
    constructor(requestSender: INifiApiConnection) {
